...
```
their empirical rejection frequencies (that is the empirical size of the tests), which is exactly the figure 14.1 in Davidson MacKinnon (2005, book).
...
Further, (14.01) reduces to $w_t = \sum^t_{s=1}{\epsilon_s}$, which enters as X'X or: 
\begin{align*}
...
Consequently, given (14.01) being I(1), $X'X \in O_p(n^2)$ and therefore cannot possibly converge to a finite probablity limit. The bias $(\hat{\beta} - \beta_0)$ therefore does not converge asymptotically in probability.