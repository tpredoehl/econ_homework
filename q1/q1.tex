...
\begin{itemize}
	...
	\item Therefore, it emerges that the actual probability of a mistaken rejection of the true H0, i.e. committing a Type 1 error\footnote{$P(R_{H_0}|H_0)$.} \highlightTP{is significantly higher than the assumed test size}{do you mean T?}.
\end{itemize}
