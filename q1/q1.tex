...
\begin{itemize}
	...
	\subitem For $\hat{\beta}$ to converge to $\beta_0$ asymptotically, the bias $(\hat{\beta} - \beta_0)$ must be $O_p(1)$: 
		\begin{align*}
		...
		\end{align*}
	\subitem The relevant assumption to be tested is therefore is $(X'X) \in n^{.5} O_p(n^{-1})$.
