...
\begin{itemize} 
	\item time series are generated as \commentTP{standardized}{blablabla} random walk processes:
		\begin{align*}
...
\begin{itemize}
	...
	\item Therefore, it emerges that the actual probability of a mistaken rejection of the true H0, i.e. committing a Type 1 error\footnote{$P(R_{H_0}|H_0)$.} is significantly higher than the assumed test size.
\end{itemize}
