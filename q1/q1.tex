...
The dispersion of the t-statistic $t_{\beta} = \frac{\beta_2 - 0}{\sigma_{\beta_2}}$

\begin{center}
	\includegraphics[width=13.36cm, height=16.8cm]{"./1aii_chart"}
\end{center}
...
\begin{center}
	\includegraphics[width=13.36cm, height=16.8cm]{"./1aiii_chart"}
\end{center}
