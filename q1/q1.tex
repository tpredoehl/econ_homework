...
\begin{itemize}
	\item The bias of $\beta_2$ does not \commentTP{converge}{this bit is from Timo} asymptotically in probability. For $\hat{\beta}$ to converge to $\beta_0$ asymptotically, the bias $(\hat{\beta} - \beta_0)$ must be $O_p(1)$: \begin{align*}
