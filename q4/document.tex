...
\begin{itemize}
	...
	\item \textbf{Cross Sectional Estimate $\hat{\lambda}$} Using the $\beta_i$ 	and the regression residuals $e^i$ obtained from (\ref{1stage}), the estimators for $\hat{\lambda}$ are derived. 
