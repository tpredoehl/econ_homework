...
\highlightTP{would you agree if we provide the sum-based solution as an alternative in the annex ?}
...
\highlightTP{simplification 3: take out 1/T. gets rid of the first sum}
